...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        backgroundPanel.setMinimumSize(new java.awt.Dimension(1000, 500));
                            ...
                            .addGroup(backgroundPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(backgroundPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, backgroundPanelLayout.createSequentialGroup()
                                        ...
                                        .addGap(62, 62, 62))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, backgroundPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        ...
        if ("parent".equals(username) && "123".equals(password)) {
            ...
            if (isChildFound) { // login successful
