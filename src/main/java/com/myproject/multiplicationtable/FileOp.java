...
public class FileOp {
    ...
    //writing to file holding child information with the .ser
    ...
    //reading from file holding child information with the .ser
    ...
    //writing to .ser file holding parents' settings (a,b,n) and scores of exercises 
    public static void writeQuestionToFile(List<Questions> qList, String fileName) {
        int id = 0; //settings id
    ...
    //reading from .ser file holding parents' settings (a,b,n) and scores of exercises 
    ...
    // .csv files required for Report.java
